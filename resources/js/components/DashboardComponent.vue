            ...
            <div class="col-2">
                <div class="position-sticky" style="top: 2rem;">   
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <button v-if="userInfo?.type==='admin'" :class="activeTab === 'userList' ? 'active' : ''" @click="redirectPage('/dashboard/user-list', 'userList')" class="nav-link" id="v-pills-messages-tab" data-toggle="pill" data-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">User list</button>
                        <button v-if="userInfo?.type==='admin'" :class="activeTab === 'categoryList' ? 'active' : ''" @click="redirectPage('/dashboard/category-list', 'categoryList')" class="nav-link" id="v-pills-messages-tab" data-toggle="pill" data-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Category list</button>
                    </div>
                </div>
            </div>
            <div class="col-10">
