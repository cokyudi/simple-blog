...
Route::get('/detail/{action}', [App\Http\Controllers\HomeController::class, 'detail'])->name('detail');

Route::group(['middleware' => 'auth', 'user-access:admin', 'prefix' => 'post'], function () {
...
Route::group(['middleware' => 'auth', 'user-access:admin'], function () {
    ...
    Route::post('/dashboard/get-categories', [App\Http\Controllers\DashboardController::class, 'getAllCategory']);
    Route::post('/dashboard/get-category-by-id', [App\Http\Controllers\DashboardController::class, 'getCategoryById']);
    Route::post('/dashboard/create-category', [App\Http\Controllers\DashboardController::class, 'createCategory']);
    Route::post('/dashboard/edit-category', [App\Http\Controllers\DashboardController::class, 'editCategory']);
    Route::post('/dashboard/delete-category', [App\Http\Controllers\DashboardController::class, 'deleteCategory']);
});
...
Route::get('/post/get_post_by_slug/{slug}', [App\Http\Controllers\PostController::class, 'getPostBySlug']);
